...
// CFileTransfersDlg 对话框



CFileTransfersDlg::CFileTransfersDlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(IDD_FILETRANSFERS_DIALOG, pParent)
{
...
BEGIN_MESSAGE_MAP(CFileTransfersDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
END_MESSAGE_MAP()
